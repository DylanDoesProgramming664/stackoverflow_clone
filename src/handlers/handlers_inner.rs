...
pub async fn create_question(
    ...
    questions_dao: Arc<dyn QuestionsDao + Sync + Send>,
...
mod tests {
    ...
    impl QuestionsDao for QuestionsDaoMock {
        ...
        async fn delete_question(&self, _: Arc<str>) -> Result<(), DBError> {
    ...
    impl AnswersDao for AnswersDaoMock {
        ...
        async fn delete_answer(&self, _: Arc<str>) -> Result<(), DBError> {
        ...
        async fn get_answers(&self, _: Arc<str>) -> Result<Vec<AnswerDetail>, DBError> {
    ...
    async fn create_question_should_return_question() {
        ...
        let question_detail = QuestionDetail {
            question_uuid: Arc::from("123".to_owned()),
            title: question.title.clone(),
            description: question.description.clone(),
            created_at: Arc::from("now".to_owned()),
        ...
        let questions_dao: Arc<dyn QuestionsDao + Send + Sync> = Arc::new(questions_dao);
    ...
    async fn create_answer_should_return_answer() {
        ...
        let answer_detail = AnswerDetail {
            answer_uuid: Arc::from("456".to_owned()),
        ...
        let answers_dao: Arc<dyn AnswersDao + Send + Sync> = Arc::new(answers_dao);
    ...
    async fn delete_answer_should_succeed() {
        let answer_id = AnswerID {
            answer_uuid: Arc::from("123".to_owned()),
        };
